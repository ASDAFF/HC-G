...
?><span class="altasib_geobase_link"><?
	...
	?></span><?
	?><span class="altasib_geobase_link_city" title="<?=$usrChoiceTitle;?>"><?
		if(!empty($usrSelCity))
			echo $usrSelCity;
...
<?						?><li<?echo($arResult["CODE"] == $sel["C_CODE"] ? ' class="altasib_geobase_act"' : '')?>><?
				...
				<div class="altasib_geobase_find">
					<input id="altasib_geobase_search" name="altasib_geobase_search" type="text" placeholder="<?=GetMessage('ALTASIB_GEOBASE_ENTER_'.$sMode);?>" autocomplete="off">
