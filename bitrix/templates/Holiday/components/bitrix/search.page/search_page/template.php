...
<?elseif(count($arResult["SEARCH"])>0):?>
    ...
    <div class="search-result-wrapper">
    	...
    	<?foreach($arResult["SEARCH"] as $arItem):?>
    		<a href="<?echo $arItem["URL"]?>"><span class="search_link"><?echo $arItem["TITLE_FORMATED"]?></span></a>
...
<?endif;?>
                ...
                <?if(count($arResult["SEARCH"])>0&&count($arResult["SEARCH"]>=$arParams['PAGE_RESULT_COUNT'])){?>
...
$(document).ready(function(){
    ...
    var container = $('.search-result-wrapper');
        ...
        $.ajax({                                                                   
           url: url,                                   
        	 ...
        	 success: function(data) {                                                      
                ...
                $(container).append($(data).find('.search-result-wrapper').contents());
                pagesCounterPlus();
                checkMoreAvailible();
                $(loading).hide('slow');
        	  }
